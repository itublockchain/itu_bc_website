...
const SocialMedia = () => {
    return (
        <div >
            <div className="flex-center bg-f4" style={{ padding: "20px 0px"}} >
                ...
                <a href="https://www.youtube.com/channel/UCeoUqhlsA4Ci2nBIBtJDTcw" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/itublockchain"  target="_blank" rel="noopener noreferrer" >
                    <img className="width10060 sm-hover"  alt="instagram"src={Instagram} />
                </a>
                ...
                <a href="https://medium.com/itu-blockchain" target="_blank" rel="noopener noreferrer">
